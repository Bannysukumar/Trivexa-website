  ...
  const getBotResponse = (userInput: string): string => {
    try {
      ...
      if (lowerInput.includes('contact') || lowerInput.includes('reach') || lowerInput.includes('get in touch')) {
        return "You can reach us at customer@trivexatechnologies.com or 6301846681. We also have a contact form on our website. Our team typically responds within 24 hours. Would you like me to help you with anything else?"
      }

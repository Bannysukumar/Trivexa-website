...
export default function HeaderOptimized() {
  ...
  return (
    ...
    >
      {/* Simplified Background Layers - Only when scrolled */}
      {isScrolled && !shouldReduceMotion && (
        <>
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group relative z-10">
            ...
            >
              ...
              <div className="absolute -inset-2 bg-gradient-to-br from-primary-600 to-navy-600 rounded-xl blur opacity-30 group-hover:opacity-60 transition-all duration-500"></div>
            </motion.div>
